...
/**
 * \file       htdocs/core/modules/fournreadinvoice/mod_fournreadfile_advanced.php
 * \ingroup    fournreadinvoice
 * \brief      File containing class for advanced numbering model of Fournreadfile
 */

dol_include_once('/fournreadinvoice/core/modules/fournreadinvoice/modules_fournreadfile.php');


/**
 *	Class to manage the Advanced numbering rule for Fournreadfile
 */
class mod_fournreadfile_advanced extends ModeleNumRefFournreadfile
{
	/**
	...
	public function info($langs)
	{
		...
		$tooltip .= $langs->trans("GenericMaskCodes4a", $langs->transnoentities("Fournreadfile"), $langs->transnoentities("Fournreadfile"));
	...
	public function getNextValue($object)
	{
		...
		$numFinal = get_next_value($db, $mask, 'fournreadinvoice_fournreadfile', 'ref', '', null, $date);
