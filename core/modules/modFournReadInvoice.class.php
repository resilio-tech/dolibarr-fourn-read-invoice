...
/**
 * 	\defgroup   fournreadinvoice     Module FournReadInvoice
 *  \brief      FournReadInvoice module descriptor.
 *
 *  \file       htdocs/fournreadinvoice/core/modules/modFournReadInvoice.class.php
 *  \ingroup    fournreadinvoice
 *  \brief      Description and activation file for module FournReadInvoice
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module FournReadInvoice
 */
class modFournReadInvoice extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 562000; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve an id number for your module

		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'fournreadinvoice';
		...
		// Module label (no space allowed), used if translation string 'ModuleFournReadInvoiceName' not found (FournReadInvoice is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// DESCRIPTION_FLAG
		// Module description, used if translation string 'ModuleFournReadInvoiceDesc' not found (FournReadInvoice is name of module).
		$this->description = "FournReadInvoiceDescription";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "FournReadInvoiceDescription";
		...
		// Key used in llx_const table to save module status enabled/disabled (where FOURNREADINVOICE is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/fournreadinvoice/css/fournreadinvoice.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/fournreadinvoice/js/fournreadinvoice.js.php',
			),
		...
		// Example: this->dirs = array("/fournreadinvoice/temp","/fournreadinvoice/subdir");
		$this->dirs = array("/fournreadinvoice/temp");

		// Config pages. Put here list of php page, stored into fournreadinvoice/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@fournreadinvoice");

		// Dependencies
		// A condition to hide module
		$this->hidden = getDolGlobalInt('MODULE_FOURNREADINVOICE_DISABLED'); // A condition to disable module;
		...
		$this->langfiles = array("fournreadinvoice@fournreadinvoice");
		...
		//$this->automatic_activation = array('FR'=>'FournReadInvoiceWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('FOURNREADINVOICE_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('FOURNREADINVOICE_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isModEnabled("fournreadinvoice")) {
			$conf->fournreadinvoice = new stdClass();
			$conf->fournreadinvoice->enabled = 0;
		}
		...
		/* Example:
		 ...
		 'tabcond'=>array(isModEnabled('fournreadinvoice'), isModEnabled('fournreadinvoice'), isModEnabled('fournreadinvoice')),
		...
		// Boxes/Widgets
		// Add here list of php file(s) stored in fournreadinvoice/core/boxes that contains a class to show a widget.
		/* BEGIN MODULEBUILDER WIDGETS */
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'fournreadinvoicewidget1.php@fournreadinvoice',
			//      'note' => 'Widget provided by FournReadInvoice',
		...
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'isModEnabled("fournreadinvoice")', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'isModEnabled("fournreadinvoice")', 'priority'=>50)
		// );
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/', 'fournreadinvoice');
		$result = $this->_load_tables('/fournreadinvoice/sql/');
		if ($result < 0) {
		...
		//$result0=$extrafields->addExtraField('fournreadinvoice_separator1', "Separator 1", 'separator', 1,  0, 'thirdparty',   0, 0, '', array('options'=>array(1=>1)), 1, '', 1, 0, '', '', 'fournreadinvoice@fournreadinvoice', 'isModEnabled("fournreadinvoice")');
		//$result1=$extrafields->addExtraField('fournreadinvoice_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', -1, 0, '', '', 'fournreadinvoice@fournreadinvoice', 'isModEnabled("fournreadinvoice")');
		//$result2=$extrafields->addExtraField('fournreadinvoice_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', -1, 0, '', '', 'fournreadinvoice@fournreadinvoice', 'isModEnabled("fournreadinvoice")');
		//$result3=$extrafields->addExtraField('fournreadinvoice_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', -1, 0, '', '', 'fournreadinvoice@fournreadinvoice', 'isModEnabled("fournreadinvoice")');
		//$result4=$extrafields->addExtraField('fournreadinvoice_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', -1, 0, '', '', 'fournreadinvoice@fournreadinvoice', 'isModEnabled("fournreadinvoice")');
		//$result5=$extrafields->addExtraField('fournreadinvoice_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', -1, 0, '', '', 'fournreadinvoice@fournreadinvoice', 'isModEnabled("fournreadinvoice")');
